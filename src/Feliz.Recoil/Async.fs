...
module AsyncUtils =
    type Recoil with
        ...
        static member inline waitForAll (recoilValues: RecoilValue<'T,#ReadOnly> []) = 
        ...
        /// Requests all dependencies in parallel and waits for all to be
        /// available before returning a value.
        static member inline waitForAll (recoilValues: RecoilValue<'T,#ReadOnly> list) = 
            Bindings.Recoil.waitForAll(ResizeArray recoilValues) 
        ...
        /// Requests all dependencies in parallel and waits for all to be
        /// available before returning a value.
        static member inline waitForAll (recoilValues: ResizeArray<RecoilValue<'T,#ReadOnly>>) = 
            Bindings.Recoil.waitForAll(ResizeArray recoilValues)
        ...
        static member inline waitForAny (recoilValues: RecoilValue<'T,#ReadOnly> []) = 
        ...
        /// Requests all dependencies in parallel and waits for at least
        /// one to be available before returning results.
        static member inline waitForAny (recoilValues: RecoilValue<'T,#ReadOnly> list) =
            Bindings.Recoil.waitForAny(ResizeArray recoilValues) 
            |> RecoilValue.map List.ofSeq
        ...
        /// Requests all dependencies in parallel and waits for at least
        /// one to be available before returning results.
        static member inline waitForAny (recoilValues: ResizeArray<RecoilValue<'T,#ReadOnly>>) = 
            Bindings.Recoil.waitForAny(ResizeArray recoilValues)
        ...
        static member inline waitForNone (recoilValues: RecoilValue<'T,#ReadOnly> []) = 
        ...
        /// Requests all dependencies in parallel and immediately returns
        /// current results without waiting.
        static member inline waitForNone (recoilValues: RecoilValue<'T,#ReadOnly> list) = 
            Bindings.Recoil.waitForNone(ResizeArray recoilValues)
            |> RecoilValue.map List.ofSeq
        /// Converts a ResizeArray of RecoilValue<'T,_> into a RecoilValue<ResizeArray<Loadable<'T>>,_>.
        ///
        /// Requests all dependencies in parallel and immediately returns
        /// current results without waiting.
        static member inline waitForNone (recoilValues: ResizeArray<RecoilValue<'T,#ReadOnly>>) = 
            Bindings.Recoil.waitForNone(ResizeArray recoilValues)
