...
module Bindings =
    ...
    type Recoil =
        ...
        static member noWait (recoilValues: seq<RecoilValue<'T,'Mode>>) : seq<RecoilValue<'T,'Mode>> = import "noWait" "recoil"
        ...
        static member waitForAll (recoilValues: seq<RecoilValue<'T,'Mode>>) : seq<RecoilValue<'T,'Mode>> = import "waitForAll" "recoil"
        static member waitForAny (recoilValues: seq<RecoilValue<'T,'Mode>>) : seq<RecoilValue<'T,'Mode>> = import "waitForAny" "recoil"
        static member waitForNone (recoilValues: seq<RecoilValue<'T,'Mode>>) : seq<RecoilValue<'T,'Mode>> = import "waitForNone" "recoil"
